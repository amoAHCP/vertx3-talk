...
cd ..
cd vertx-users-read-spring && mvn clean package
cp target/vertx-users-read-spring-1.0-SNAPSHOT-fat.jar ../demoOne/
cd ..
cd vertx-aggregator-vxms && mvn clean package
cp target/vertx-aggregator-vxms-1.0-SNAPSHOT-fat.jar ../demoOne/
cd ..