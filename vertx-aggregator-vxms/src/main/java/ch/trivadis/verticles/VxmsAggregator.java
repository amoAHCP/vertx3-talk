...
public class VxmsAggregator extends VxmsEndpoint {
    ...
    public void userPOST(RestHandler handler) {
        System.out.println("userPOST: "+handler.request().body().toString());
    ...
    public void userGetById(RestHandler handler) {
        System.out.println("userGetById: "+handler.request().param("id"));
    ...
    public void userPutById(RestHandler handler) {
        System.out.println("userPutById: "+handler.request().param("id")+"  "+handler.request().body().toString());
